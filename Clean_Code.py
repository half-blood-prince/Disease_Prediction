...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("F:\\C++\\Python\\Disease-prediction-using-Machine-Learning-master\\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("F:\\C++\\Python\\Disease-prediction-using-Machine-Learning-master\\Testing.csv")
...
#w2 = Label(root, justify=LEFT, text="A Project by YASH SINGH", fg="white", bg="blue")
